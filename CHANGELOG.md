...
- **gvsecretsync** — Fixed `sec` command crash when run without subcommand
  - `args.name` was not defined when status was called as default action

### Changed

- **gv** — Added 12 missing tools to the help display
  - gvconfigrender, gvdeploy, gvdnsprovider, gvhealth, gvjournal, gvmetrics
  - gvnginxctl, gvpolicy, gvrebootctl, gvsync, gvsystemdctl, gvtcptest
